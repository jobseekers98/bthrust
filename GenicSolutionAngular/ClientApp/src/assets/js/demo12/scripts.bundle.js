...
var KTLayout = function() {
 ...
 $(".customer-list-view-info").click(function(){
   window.location = "./?page=customer-list-view";
 });
 $(".property-list-view-info").click(function(){
   window.location = "./?page=property-list-view";
 });
 $(".request-list-view-info").click(function(){
   window.location = "./?page=request-list-view";
 });
 $(".quote-list-view-info").click(function(){
   window.location = "./?page=quot-list-view";
 });
 $(".invoice-list-view-info").click(function(){
   window.location = "./?page=invoice-list-view";
 });
 $(".ticket-list-view-info").click(function(){
   window.location = "./?page=tickets-list-view";
 });
 $(".engineer-list-view").click(function(){
   window.location = "./?page=engineer-list-view";
 });
 
 $(".create-quote-client-item").click(function(){
   window.location = "./?page=quote-for-client";
 });
 $(".client-invoice-item-info").click(function(){
   window.location = "./?page=invoice-for-client";
 });
 $(".client-tickets-info-item").click(function(){
   window.location = "./?page=tickets-for-client";
 });
...
$(document).ready(function(){
	...
	$('.right-enlarge').on('click', function() {
		if($(this).hasClass('col-lg-1')){
			$(this).removeClass('col-lg-1');
			$(this).addClass('col-lg-2');
			$('.left-enlarge').removeClass('col-lg-11');
			$('.left-enlarge').addClass('col-lg-10');
            
		}else{
			$(this).removeClass('col-lg-2');
			$(this).addClass('col-lg-1');
			$('.left-enlarge').removeClass('col-lg-10');
			$('.left-enlarge').addClass('col-lg-11');
