...
export class LeaveCalendarComponent implements OnInit {
  ...
  minDate = { year: Number(this.currentUTCDate.getFullYear()), month: 1, day: 1};
  maxDate = { year: Number(this.currentUTCDate.getFullYear()) + 2, month: 12, day: 31 };
  constructor(
    public service: GenicProfileService,
    private toastr: ToastrService,
    public logService: UserlogService,
    public loginservice: AuthenticationService,
    public dialogRef: MatDialogRef<LeaveCalendarComponent>) {
  ...
  onSubmit() {
    if (this.validateForm()) {
      ...
      this.service.GenicProfileCalendarData.LeaveFor = 1;
