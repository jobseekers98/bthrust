...
/* harmony import */ var _login_mudule__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./login.mudule */ "w9Ex");
...
class AuthenticationService {
    ...
    GetUsersList(token) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/GetUserList/' + token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => { return Response; }));
    }
    // change user Permission
    changeUserStatus(token, UserId) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/changeUserStatus/' + token + '/' + UserId, null).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => {
            return Response;
        }));
    }
    getPermissionData(Id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/GetUserWisePermissionList/' + Id)
    ...
    updateUserPermission(token, type) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/putUserPermissions/' + token + '/' + type, this.PermissionData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => {
            return Response;
        }));
    }
    updateUserProfile(token) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/putUserProfile/' + token, this.localLoginData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => { return Response; }));
    }
    AddNewUserProfile1() {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/AdNewUser', this.localLoginData).toPromise().then(res => this.localLoginData = res);
    }
    AddNewUserProfile(token) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/AdNewUser/' + token, this.localLoginData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => {
            return Response;
        }));
    }
    getengineerslist(Token) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/GetEngineerList/' + Token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => {
            return Response;
        }));
    }
    getUserPermissions(t, userId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl + '/api/Logins/GetPermissions/' + t + '/' + userId)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => {
            return Response;
        }));
    }
...
//# sourceMappingURL=default~application-application-module~auth-auth-module~userprofile-userprofile-module-es2015.js.map