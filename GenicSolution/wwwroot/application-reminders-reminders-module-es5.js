(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["application-reminders-reminders-module"], {
    ...
    /***/
    function gti(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var src_app_services_reminder_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      function ReminderComponent_li_33_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReminderComponent_li_33_Template_a_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9);

            var ctx_r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r8.loadData("ticket");
          });
      ...
      function ReminderComponent_li_34_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReminderComponent_li_34_Template_a_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r11);

            var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r10.loadData("quote");
          });
      ...
      function ReminderComponent_li_35_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReminderComponent_li_35_Template_a_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

            var ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r12.loadData("invoice");
          });
      ...
      function ReminderComponent_div_52_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ReminderComponent_span_59_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ReminderComponent_span_60_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
      ...
      function ReminderComponent_span_61_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
      ...
      function ReminderComponent_tr_73_div_15_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function ReminderComponent_tr_73_div_15_Template_input_change_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r20);

            var ctx_r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            var x_r14 = ctx_r21.$implicit;
            var i_r15 = ctx_r21.index;

            var ctx_r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r19.onWorkerStatusChange($event, x_r14.Id, i_r15);
          })("ngModelChange", function ReminderComponent_tr_73_div_15_Template_input_ngModelChange_1_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r20);

            var x_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function ReminderComponent_tr_73_span_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function ReminderComponent_tr_73_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var ReminderComponent = /*#__PURE__*/function () {
        function ReminderComponent(titleService, reminderservice, loginservice, toastr) {
          var _this = this;
        ...
        _createClass(ReminderComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.reminderservice.getAllReminders(this.currentUser.Token, 'ticket').subscribe(function (res) {
              if (res) {
                var response = res;
                ...
                if (response.Message === 'success') {
                  _this2.data = [];
                  _this2.tempdata = [];
                  _this2.data = response.result;
                  _this2.tempdata = response.result;

                  _this2.dtTrigger.next();

                  _this2.changetype(_this2.dropdowntypevalue);
                }
              }
            }, function (error) {
          ...
          key: "loadData",
          value: function loadData(t) {
            var _this3 = this;

            this.trname = t;
            this.dropdownbtnavgrev = t;
            this.reminderservice.getAllReminders(this.currentUser.Token, t).subscribe(function (res) {
              if (res) {
                var response = res;
                ...
                if (response.Message === 'success') {
                  ...
                  _this3.tempdata = response.result;

                  _this3.changetype(_this3.dropdowntypevalue);
                }
              }
            }, function (error) {
              return console.log(error);
          ...
          value: function changetype(t) {
            ...
            switch (t) {
              case 0:
                ...
                this.data = this.tempdata.filter(function (s) {
          ...
          key: "onWorkerStatusChange",
          value: function onWorkerStatusChange(e, id, index) {
            var _this5 = this;
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
              ...
              if (result.value) {
                ...
                _this5.loadData(type);
              } else if (result.dismiss === sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.DismissReason.cancel) {
                _this5.reminderservice.putReminderStatus(_this5.currentUser.Token, id, type).subscribe(function (res) {
                  if (res) {
                    var response = res;

                    if (response.Message === 'success') {
                      _this5.toastr.success('success', response.MessageDescription);

                      _this5.data[index].IsActive = e.target.checked;
      ...
      ReminderComponent.ɵfac = function ReminderComponent_Factory(t) {
        return new (t || ReminderComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__["Title"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_reminder_service__WEBPACK_IMPORTED_MODULE_5__["ReminderService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_6__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](ngx_toastr__WEBPACK_IMPORTED_MODULE_7__["ToastrService"]));
      };

      ReminderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 74,
        vars: 12,
        consts: [["id", "kt_content", 1, "kt-content", "kt-grid__item", "kt-grid__item--fluid", "kt-grid", "kt-grid--hor"], ["id", "kt_subheader", 1, "kt-subheader", "kt-grid__item"], [1, "kt-container", "kt-container--fluid"], [1, "kt-subheader__main"], [1, "kt-subheader__title"], ["href", "javascript:;", "routerLink", "/dashboard"], [1, "kt-subheader__separator", "kt-hidden"], [1, "kt-subheader__breadcrumbs"], ["aria-hidden", "true", 1, "fa", "fa-angle-double-right"], [1, "kt-subheader__breadcrumbs-separator"], [1, "kt-subheader__toolbar"], [1, "kt-subheader__wrapper"], [1, "customer-list-main-section"], [1, "kt-widget17"], [1, "kt-widget17__visual", "kt-widget17__visual--chart", "kt-portlet-fit--top", "kt-portlet-fit--sides", 2, "background-color", "#fd397a"], [1, "kt-widget17__stats"], [1, "kt-widget17__items"], [1, "kt-section", "kt-drop-section"], [1, "kt-portlet__body", "customer-listing-datatable"], ["id", "list-panel", 1, "panel", "panel-primary", "list-panel"], [1, "panel-heading", "list-panel-heading"], [1, "panel-title", "list-panel-title"], [1, "fa", "fa-list"], [1, "scFilter"], [1, "btn-group", "btn-group-sm"], ["href", "javascript:;", "data-toggle", "dropdown", 1, "btn", "btn-primary", "dropdown-toggle"], [1, "caret"], [1, "dropdown-menu", 2, "text-align", "left", "padding", "0"], ["style", "width: 100%;", 4, "ngIf"], [2, "width", "100%"], ["href", "javascript:;", 3, "click"], [1, "panel-body"], ["class", " col-md-12 alert alert-info", 4, "ngIf"], ["datatable", "", 1, "table", "table-striped", "properies-table-info", "ng-star-inserted", 3, "dtOptions", "dtTrigger"], ["role", "row"], ["width", "5%"], ["width", "10%"], [4, "ngIf"], ["width", "15%"], ["width", "35%"], ["width", "20%"], [4, "ngFor", "ngForAsync", "ngForOf"], [1, "col-md-12", "alert", "alert-info"], ["class", "custom-switch custom-switch-label-yesno pl-0", 4, "ngIf"], ["class", "ticketstatus statusoverdue", 4, "ngIf"], [1, "custom-switch", "custom-switch-label-yesno", "pl-0"], ["name", "x.IsActive", "type", "checkbox", 1, "custom-switch-input", "ng-valid", "ng-dirty", "ng-touched", 3, "id", "ngModel", "change", "ngModelChange"], ["x.IsActive", "ngModel"], [1, "custom-switch-btn", 3, "for"], [1, "ticketstatus", "statusoverdue"]],
        template: function ReminderComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReminderComponent_Template_a_click_43_listener() {
              return ctx.changetype(2);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReminderComponent_Template_a_click_46_listener() {
              return ctx.changetype(1);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ReminderComponent_Template_a_click_49_listener() {
              return ctx.changetype(0);
            });
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ReminderComponent, [{
          ...
          return [{
            ...
            type: src_app_services_reminder_service__WEBPACK_IMPORTED_MODULE_5__["ReminderService"]
          }, {
    ...
    function h2(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "RemindersComponent", function () {
      ...
      var RemindersComponent = /*#__PURE__*/function () {
        function RemindersComponent() {
          _classCallCheck(this, RemindersComponent);
        }

        _createClass(RemindersComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {}
        }]);
      ...
      RemindersComponent.ɵfac = function RemindersComponent_Factory(t) {
        return new (t || RemindersComponent)();
      };

      RemindersComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RemindersComponent, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
          args: [{
    ...
    /***/
    function jtnU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RemindersModule", function () {
      ...
      var _reminder_reminder_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./reminder/reminder.component */
      "0gti");
      /* harmony import */


      var _reminders_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./reminders.component */
      "h++2");

      var routes = [{
        path: '',
        component: _reminders_component__WEBPACK_IMPORTED_MODULE_9__["RemindersComponent"],
        children: [{
          path: 'reminder',
          component: _reminder_reminder_component__WEBPACK_IMPORTED_MODULE_8__["ReminderComponent"]
        }]
      }];

      var RemindersModule = function RemindersModule() {
        _classCallCheck(this, RemindersModule);
      };

      RemindersModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: RemindersModule
      });
      RemindersModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function RemindersModule_Factory(t) {
          return new (t || RemindersModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], angular_datatables__WEBPACK_IMPORTED_MODULE_4__["DataTablesModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _agm_core__WEBPACK_IMPORTED_MODULE_6__["AgmCoreModule"].forRoot({
          apiKey: src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].googleapiKey
        }), _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forChild(routes)]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](RemindersModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](RemindersModule, [{
...
//# sourceMappingURL=application-reminders-reminders-module-es5.js.map