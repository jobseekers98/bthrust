...
class PropertyService {
    ...
    postPropertyDetails(token) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/' + token, this.formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
    putPropertyDetails(token) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/' + token, this.formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
    putPropertyUpdateStatus(token) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/PutPropertyStatusActiveInactive/' + token, null)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
    refrestPropertylist(token) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/Get/' + token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
    refrestPropertyById(id) {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/' + id).toPromise().then(res => this.Propertylist = this.locallist = res);
    }
    refrestPropertylistCustomerWise(token, CId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/GetPropertyCustomerWise/' + token + '/' + CId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
    getAddressUsingPostalCode(pc) {
        return this.http.get('https://maps.googleapis.com/maps/api/geocode/json?address=' + pc +
            '&sensor=false&key=' + src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].googleapiKey).toPromise().then(res => res);
    }
    ...
    getPropertyData(Id) {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/getPropertyDataByProperyId/' + Id).toPromise().then(res => this.formData = res);
    }
    getLatLongUsingZipCode(ZipCode) {
        return this.http.get('https://maps.googleapis.com/maps/api/geocode/json?address=' + ZipCode +
            '&key=' + src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].googleapiKey).pipe(res => res);
    }
    AddNewProperty() {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/AddNewProperty', this.formData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => { return Response; }));
    }
    ClientTicketHistory(ticketId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/TicketHistoryViewDetails/' + ticketId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => { return Response; }));
    }
    getAddressUsingPostalCodeSync(pc) {
        return this.http.get('https://maps.googleapis.com/maps/api/geocode/json?address=' + pc +
            '&sensor=false&key=' + src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].googleapiKey).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
    getAddressByLatLong(latlng) {
        return this.http.get('https://maps.googleapis.com/maps/api/geocode/json?latlng=' + latlng + '&key=' + src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].googleapiKey).pipe(res => res);
    }
    CustomerAddressLatLongGet(moduletype) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/CustomerAddressLatLong/' + moduletype).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
    CustomerAddressLatLongGetUpdate(moduletype) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Properties/CustomerAddressLatLongUpdate/' + moduletype, this.formData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(Response => Response));
    }
}
PropertyService.ɵfac = function PropertyService_Factory(t) { return new (t || PropertyService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"])); };
...
//# sourceMappingURL=default~application-calendar-calendar-module~application-customer-customer-module~application-custom~b079fad2-es2015.js.map