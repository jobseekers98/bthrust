...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CloserDetails", function() { return CloserDetails; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CloserAttachment", function() { return CloserAttachment; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CloserAttachmentAduio", function() { return CloserAttachmentAduio; });
class CloserDetails {
}
class CloserAttachment {
}
class CloserAttachmentAduio {
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServiceformService", function() { return ServiceformService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/environments/environment */ "AytR");
/* harmony import */ var _closerDetails_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./closerDetails.module */ "wyZL");
...
class ServiceformService {
    ...
    removeAssignedServiceForm(token, Id) {
        return this.http.delete(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/DeleteAssignedServiceForm/' + token + '/' + Id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response));
    }
    asignServiceformToTicket(token) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/asignServiceformToTicket/' + token, this.tempTicketwiseServiceFormList).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response));
    }
    getAssignedServiceFormListByTicket(token, TicketId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/GetAssignedServiceFormByTicket/' + token + '/' + TicketId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response));
    }
    // GET: Closer Details form cliend service form
    getCloserDetailsFormServiceForm(TicketId) {
        this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/getCloserDetailsFormServiceForm/' + TicketId).toPromise().then(res => this.CloserDetailsData = res);
    }
    downoadServiceFormPDF(CloserId) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/getServiceFormPDF/' + CloserId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => { return Response; }));
    }
    ...
    // }
    CheckServiceFormStatus(token, closerid) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/CheckServiceFormStatus/' + token + '/' + closerid)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(Response => Response));
    }
    // //#endregion
    //#region FSM Service Form
    getFSMServiceFormById(token, Id) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/GetServiceFormById/' + token + '/' + Id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response));
    }
    putFSMServiceFormDetails(token, TicketId, ispreview) {
        return this.http.put(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/PutServiceForm/' + token + '/' + TicketId + '/' + ispreview, this.FSMServiceFormData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response));
    }
    postFSMServiceFormDetails(token, TicketId, SequenceId, ispreview) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/api/Services/PostServiceForm/' + token + '/' + TicketId + '/' + SequenceId + '/' + ispreview, this.FSMServiceFormData)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => response));
    }
}
ServiceformService.ɵfac = function ServiceformService_Factory(t) { return new (t || ServiceformService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"])); };
ServiceformService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: ServiceformService, factory: ServiceformService.ɵfac, providedIn: 'root' });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ServiceformService, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"],
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] }, { type: src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_5__["AuthenticationService"] }]; }, null); })();


/***/ })

}]);
//# sourceMappingURL=default~application-customer-customer-module~application-engineer-engineer-module~application-proper~daa8d22b-es2015.js.map